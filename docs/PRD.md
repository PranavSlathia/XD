...
> **Historical record.** `docs/XD-PRD.md` is the current product source of
> truth. It supersedes the dashboard, GitHub-first, CZDS-first, single-funnel,
> and 20–50 daily-candidate assumptions below.
